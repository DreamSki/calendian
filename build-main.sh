...
cat src/reminders/temporal.js src/macos/helper-executor.js src/cache/schedule-cache.js src/macos/writer.js src/macos/notifications.js src/notes/frontmatter.js src/notes/note-link-resolver.js src/notes/templates.js src/notes/codeblock.js >> main.js
